...
BACKGROUND_COLOR = (197, 222, 217)
SNAKE_HEAD_COLOR = (76, 156, 73)
SNAKE_SEGMENT_COLOR = (81, 171, 79)
FOOD_COLOR = (0, 255, 0)
BLOCK_COLOR = (0, 0, 150)
COLORKEY_COLOR = (255, 255, 0)

SCORE_COLOR = (67, 67, 77)
SCORE_POS = (10, 10)
SCORE_PREFIX = 'Score: '
...
class food(pygame.sprite.Sprite):
    def __init__(self, takenupgroup):
        ...
        self.image = pygame.transform.scale(food_image, TILE_SIZE)
        self.rect = self.image.get_rect()
...
class block(pygame.sprite.Sprite):
    def __init__(self, takenupgroup):
        ...
        self.image = pygame.transform.scale(stone_image, TILE_SIZE)
        self.rect = self.image.get_rect()
...
class Game():
    ...
    def step(self, direction):
        ...
        return self.getObservation(), self.reward, self.lose, info
    ...
    def render(self, mode):
        ...
        # score
        d = self.screen.blit(self.bg, SCORE_POS, pygame.Rect(SCORE_POS, (70, 70)))
